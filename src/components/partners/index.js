        ...
        <div className="row">
          <div className="col-lg-10 mx-auto">
            <div className="partner-inn">
              <ul>
                <li>
                  <img src={partnerImg1} width="250px" alt="img" />
                </li>
                <li>
                  <img src={partnerImg2} width="150px" alt="img" />
                </li>
                <li>
                  <img src={partnerImg3} width="80px" alt="img" />
                </li>
                <li>
                  <img src={partnerImg7} width="120px" alt="img" />
                </li>
                <li>
