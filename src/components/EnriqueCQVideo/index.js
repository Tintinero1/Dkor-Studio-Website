...
import tourBG from "../../img/enriqueCQ_miniatura.png";

import "./style.css";

const EnriqueCQVideo = () => {
  return (
        ...
        <div className="row">
          <div className="col-lg-6 offset-lg-6 col-md-8 offset-md-4">
            <div className="site-heading">
              <h3 className="sub-title">Recorrido Planta Baja</h3>
            ...
            <div className="tour-inn" data-aos="fade-up">
              ...
              <div className="video-main">
                <div className="tour_video_waves">
                  ...
                  <VideoModal videoId="sXIHTlCg8yo" />
                </div>
              </div>
            </div>
          </div>
